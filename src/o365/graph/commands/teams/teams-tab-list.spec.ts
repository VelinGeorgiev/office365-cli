...
const command: Command = require('./teams-tab-list');
...
describe(commands.TEAMS_TAB_LIST, () => {
  ...
  it('logs correct telemetry event', (done) => {
    ...
    cmdInstance.action({ options: {} }, () => {
      try {
        assert.equal(telemetry.name, commands.TEAMS_TAB_LIST);
        done();
      }
      catch (e) {
        done(e);
          ...
          value: [
            {
              ...
              "displayName":"Office365-cli",
              "webUrl":"https://teams.microsoft.com/l/channel/19%3a552b7125655c46d5b5b86db02ee7bfdf%40thread.skype/tab%3a%3a5a2f05cf-0b6d-4012-b296-342d89158248?webUrl=https%3a%2f%2fgithub.com%2fpnp%2foffice365-cli&label=Office365-cli&groupId=aa5cf078-46e3-4bcf-9e02-e15ff6efe889&tenantId=a1d5f937-b756-46d7-b92f-464629a6d985",
              "configuration":{"entityId":null,"contentUrl":"https://github.com/pnp/office365-cli","removeUrl":null,"websiteUrl":"https://github.com/pnp/office365-cli","dateAdded":"2019-03-28T18:35:53.81Z"},
