...
class GraphTeamsArchiveCommand extends GraphCommand {
  ...
  public get description(): string {
    return 'Archive specified Microsoft Teams team';
  }

  public getTelemetryProperties(args: CommandArgs): any {
    const telemetryProps: any = super.getTelemetryProperties(args);
    telemetryProps.shouldSetSpoSiteReadOnlyForMembers = typeof args.options.shouldSetSpoSiteReadOnlyForMembers !== 'undefined';
  ...
  public commandAction(cmd: CommandInstance, args: CommandArgs, cb: () => void): void {
    ...
    auth
      ...
      .then((): request.RequestPromise => {
        ...
        const siteReadOnlyForMembers: boolean = typeof args.options.shouldSetSpoSiteReadOnlyForMembers !== 'undefined';
        const requestOptions: any = {
          url: `${endpoint}/teams/${encodeURIComponent(args.options.teamId)}/archive`,
  ...
  public options(): CommandOption[] {
    const options: CommandOption[] = [
      ...
      },
      {
        ...
        description: 'Sets the permissions for team members to read-only on the SharePoint Online site associated with the team. Default false'
      }
    ];
  ...
  Remarks:
    ...
    To archive a Microsoft Teams team, you have to first log in to the Microsoft Graph using the
