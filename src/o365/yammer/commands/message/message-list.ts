...
class YammerMessageListCommand extends YammerCommand {
  ...
  public commandHelp(args: {}, log: (help: string) => void): void {
    ...
    log(
      ...
      In order to use this command, you need to grant the Azure AD application used by 
      the Office 365 CLI the permission to the Yammer API. 
      To do this, execute the "consent --service yammer" command.
