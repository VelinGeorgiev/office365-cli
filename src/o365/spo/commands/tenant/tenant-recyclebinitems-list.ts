...
import { SPODeletedSitePropertiesEnumerable } from './SPODeletedSitePropertiesEnumerable';
const vorpal: Vorpal = require('../../../../vorpal-init');

class SpoTenantRecycleBinItemsListCommand extends SpoCommand {
  public get name(): string {
    return commands.TENANT_RECYCLEBINITEMS_LIST;
  }
  ...
  public commandAction(cmd: CommandInstance, args: any, cb: (err?: any) => void): void {
    ...
    this
      ...
      .then((res: string): void => {
        ...
        const results: SPODeletedSitePropertiesEnumerable = json[json.length - 1];
  ...
  Examples:
    ...
    Returns all modern and classic site collections in the tenant scoped recycle bin
      ${commands.TENANT_RECYCLEBINITEMS_LIST}
  `);
  }
}

module.exports = new SpoTenantRecycleBinItemsListCommand();